...
import uz.ergashov.pdp_meal.bot.PDPFoodBot;
import uz.ergashov.pdp_meal.repository.auth.AuthRepository;
import uz.ergashov.pdp_meal.repository.permission.PermissionRepository;
import uz.ergashov.pdp_meal.repository.role.RoleRepository;

@SpringBootApplication
public class PdpMealApplication/* implements ComandLineRunner */{
    ...
    @Autowired
    public PdpMealApplication(PasswordEncoder passwordEncoder, PermissionRepository permissionRepository,
